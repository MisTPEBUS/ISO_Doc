...
using IsoDocument.Api.Features.IsoCategories.Validators;
...
builder.Services.AddScoped<IValidator<CreateIsoCategoryRequest>, CreateIsoCategoryRequestValidator>();
builder.Services.AddScoped<IValidator<UpdateIsoCategoryRequest>, UpdateIsoCategoryRequestValidator>();
...
builder.Services.AddScoped<IIsoCategoryStore, EfIsoCategoryStore>();
builder.Services.AddScoped<IIsoCategoryService, IsoCategoryService>();
